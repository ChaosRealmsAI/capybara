...
for command in \
  ...
  chat project context patch canvas image game-assets motion help media poster component timeline tts clips agent quit; do
...
for command in image cutout game-assets motion canvas chat agent clips media timeline tts; do
