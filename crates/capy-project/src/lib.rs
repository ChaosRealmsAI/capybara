...
pub use model::{
    ...
    ProjectInspectionV1, ProjectManifestV1, ProjectSurfaceNodeV1, ProjectSurfaceNodesV1,
    ProjectWorkbenchCardV1, ProjectWorkbenchV1, ReplaceExactTextOperationV1,
    SURFACE_NODES_SCHEMA_VERSION, SurfaceGeometryV1, WorkbenchPreviewV1,
};
