...
16. `target/debug/capy project clip-queue proposal --project <dir>`
17. `target/debug/capy project clip-queue proposal-history --project <dir>`
18. `target/debug/capy project generate --project <dir> --artifact <art_id> --provider fixture --prompt "Make this clearer" --review`
19. `target/debug/capy project generate --project <dir> --artifact <art_id> --provider fixture --prompt "Tighten this headline" --selector '[data-capy-section="hero-title"]' --review`
20. `target/debug/capy project campaign plan --project <dir> --brief "Launch one coherent campaign"`
21. `target/debug/capy project campaign generate --project <dir> --brief "Launch one coherent campaign"`
22. `target/debug/capy project run show --project <dir> <run_id>`
23. `target/debug/capy project run accept --project <dir> <run_id>`
24. For real AI prompt evidence, run `target/debug/capy project generate --project <copy> --artifact <art_id> --provider codex --prompt "Make this clearer" --live --sdk-response <fixture.json> --review --save-prompt <prompt.json>`
...
Clip queue proposal history output: `capy.project-video-clip-proposal-history.v1` with persisted proposal `entries[]`, revision/hash, changes, decision, and conflict snapshots. It is read-only audit state and cannot apply old proposals.
