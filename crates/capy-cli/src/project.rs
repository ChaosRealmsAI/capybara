...
#[command(
  ...
  Common commands: init, inspect, design-language inspect, design-language validate, workbench, import-video, clip-queue inspect|write|analyze|semantics|suggest, generate, campaign, run, add-design, add-artifact.
