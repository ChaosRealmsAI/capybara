...
impl Settings {
    ...
    /// Controls whether Chromium GPU rendering and compositing are disabled.
    ///
    /// The default is `true`, matching WEF's original offscreen-rendering
    /// behavior. Native windowed previews can set this to `false`.
    pub fn disable_gpu(mut self, disable_gpu: bool) -> Self {
