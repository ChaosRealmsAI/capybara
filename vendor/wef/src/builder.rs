    ...
    T: BrowserHandler,
{
    ...
    /// Creates a native child-window browser instead of an offscreen renderer.
    ///
    /// The default is windowless/offscreen rendering.
    ...
    /// Creates a windowless/offscreen browser.
    ///
    /// This is the default mode.
    pub fn windowless(self) -> Self {
        Self {
            windowless: true,
            ..self
        }
